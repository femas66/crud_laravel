...
Route::group(['middleware' => 'cekLogin'], function () {
    ...
    Route::put('/editwarga/store', [DashboardController::class, 'actioneditwarga'])->name('editwarga'); // revisi put
    ...
    Route::prefix('hobi')->group(function () {
        ...
        Route::delete('/{id}', [HobiController::class, 'delete'])->name('hobi.delete');
    });
    ...
    Route::prefix('vaksin')->group(function () {
        ...
        Route::delete('/{id}', [VaksinController::class, 'delete'])->name('vaksin.delete');
    });
    //halaman agama
