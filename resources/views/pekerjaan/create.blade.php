        ...
        <div class="row align-items-stretch no-gutters contact-wrap">
          <div class="col-md-12">
            <div class="form h-100">
              ...
              @endif
              <form class="mb-5" action="{{ route('pekerjaan.store') }}" method="post">
                @csrf
                <div class="row">
                ...
                <div class="row">
                  <div class="col-md-6 form-group mb-3">
                    ...
                    <input type="text" class="form-control" name="pekerjaan" id="nik"  placeholder="Pekerjaan" value="{{ old('pekerjaan') }}">
                ...
                <div class="row">
                  <div class="col-md-12 form-group mb-3">
                    ...
                    <textarea class="form-control" name="alamat" id="message" cols="30" rows="4"  placeholder="Alamat">{{ old('alamat') }}</textarea>
