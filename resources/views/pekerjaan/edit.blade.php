...
@endif
    ...
    <div class="mb-3">
      ...
      <input type="text" name="pekerjaan" class="form-control" id="tanggal" placeholder="Pekerjaan" value="{{ $pekerjaan->pekerjaan }}">
    </div>
    <div class="mb-3">
      <label for="tanggal" class="form-label">Alamat</label>
      <input type="text" name="alamat" class="form-control" id="tanggal" placeholder="Alamat" value="{{ $pekerjaan->alamat }}">
    </div>
    <div class="mb-3">
      <label for="tanggal" class="form-label">Gaji</label>
      <input type="number" name="gaji" class="form-control" id="tanggal" placeholder="Gaji" value="{{ $pekerjaan->gaji }}">
    </div>
    <div class="mb-3">
